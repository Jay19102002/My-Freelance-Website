...
export class BaseConversation {
    ...
    handleAgentReasoningResponsePart(event) {
    ...
    async uploadFile(file) {
        if (this.options.orchestrator) {
            ...
            throw new Error("uploadFile is not supported for self-hosted orchestrator sessions.");
        }
        return uploadFile({
