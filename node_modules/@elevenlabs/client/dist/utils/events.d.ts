import type { AgentChatResponsePartClientEvent, AgentReasoningResponsePartClientEvent, AgentResponse, AgentResponseCorrection, AgentToolResponseClientEvent, AgentToolResponseFullPayloadClientEvent, AgentTypingClientEvent, AsrInitiationMetadataEvent as AsrMetadataEvent, Audio, AgentToolRequestClientEvent, ClientToolCallMessage, ContextUsageClientEvent, ConversationMetadata, ErrorMessage, ExternalAgentConnectedClientEvent, GuardrailTriggered, Interruption, McpConnectionStatusClientEvent, McpToolCall, Outgoing, Ping, InternalTentativeAgentResponse as TentativeAgentResponseInternal, UserTranscript, VadScore, RichContentClientEvent } from "@elevenlabs/types";
...
export type AgentToolResponseFullPayloadEvent = AgentToolResponseFullPayloadClientEvent;
...
export type AgentReasoningResponsePartEvent = AgentReasoningResponsePartClientEvent;
...
export type IncomingSocketEvent = UserTranscriptionEvent | AgentResponseEvent | AgentResponseCorrectionEvent | AgentAudioEvent | InterruptionEvent | InternalTentativeAgentResponseEvent | ConfigEvent | PingEvent | ContextUsageEvent | ClientToolCallEvent | VadScoreEvent | MCPToolCallClientEvent | AgentToolRequestEvent | AgentToolResponseEvent | AgentToolResponseFullPayloadEvent | ConversationMetadataEvent | AsrInitiationMetadataEvent | MCPConnectionStatusEvent | AgentChatResponsePartEvent | AgentReasoningResponsePartEvent | RichContentEvent | ErrorMessageEvent | GuardrailTriggeredEvent | AgentTypingEvent | ExternalAgentConnectedEvent;
